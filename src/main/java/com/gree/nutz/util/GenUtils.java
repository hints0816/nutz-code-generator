...
public class GenUtils
{
    ...
    public static void initTable(GenTable genTable, String operName)
    {
        ...
        genTable.setBusinessName(StringUtils.isNotEmpty(genTable.getIsDynamic())?getBusinessName(genTable.getClassName()):getBusinessName(genTable.getTableName()));
